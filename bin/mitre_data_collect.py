...
# https://github.com/sduff/mitre_attack_csv/blob/main/mitre_attack_csv.py
...
filename = argvals.get("file", None)

# print("https://github.com/mitre/cti/raw/master/"+filename+"/"+filename+".json")
# print("..\lookups\\"+filename+".json")
if filename == "enterprise-attack":
	kill_phase = "mitre-attack"
else:
	kill_phase = "mitre-"+filename
url = "https://github.com/mitre/cti/raw/master/"+filename+"/"+filename+".json"
outfile = "..\lookups\\"+filename+".csv"
...
for i in j['objects']:
	...
	if ('revoked' in i and i['revoked']==True) or ('x_mitre_deprecated' in i and i['x_mitre_deprecated']==True) or ('x_mitre_is_subtechnique' in i and i['x_mitre_is_subtechnique']==True) :
		continue
...
for tn in o['attack-pattern']:
	...
	kill_chain_phases = [tactics[x['phase_name']] for x in kill_chain_phases if x['kill_chain_name']==kill_phase]
